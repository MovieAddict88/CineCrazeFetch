...
/**
 * JSON Data Service that fetches data from GitHub JSON URL
 */
public class JsonDataService {
    ...
    public static void getHomeData(HomeDataCallback callback) {
        Log.d(TAG, "Starting JSON data fetch from: " + JSON_URL);
        executor.execute(() -> {
            try {
    ...
    public static void discoverMovies(String genres, String sortBy, int page, MovieListCallback callback) {
        // For JSON data, we'll just return all movies since we can't filter easily
