...
public interface apiRest {
    ...
    @FormUrlEncoded
    @POST("comment/channel/add/" + Global.SECURE_KEY + "/")
    ...
    @GET("comments/by/channel/{id}/" + Global.SECURE_KEY + "/")
    Call<List<Comment>> getCommentsByChannel(@Path("id") Integer id);


    @FormUrlEncoded
    @POST("comment/poster/add/" + Global.SECURE_KEY + "/")
    ...
    @FormUrlEncoded
    @POST("rate/channel/add/"+Global.SECURE_KEY+"/")
